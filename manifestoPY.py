...
test = Manifesto('434b23a00dd22cba36b8ac52ccda71b4')
#a = test.mp_coreversions()
#b = test.mp_corecitation('MPDS2016a')
#c = test.mp_corpuscitation('2015-3')
#d = test.mp_metaversions()
#e = test.mp_maindataset()
